...
\begin{theorem}[{\cite[Theorem 1.1.8.]{MR1659509}}]\label{theorem:real-field}
...
\begin{definition}[\cite{MR3069467}] \label{definition:RCF} \todo{場所を原論文で特定}
...
\begin{theorem}[\cite{MR3069467}] \label{theorem:real-closed-field} \todo{場所を原論文で特定}
     体$F$について，以下は同値である．
     \begin{enumerate}
          \item 体$F$は実閉体である．
