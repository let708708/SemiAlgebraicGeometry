...
実閉体$R$を係数とする一変数多項式について，実数$\R$上の連続関数，または可微分関数と同様の性質が成り立つ．
...
% 実閉体における解析的な性質について言及するべきである．
% 中間地の定理や平均値の定理について述べておくべき．
...
このとき，$1$以上の自然数$s, m$に対して，$P_{s,m}$を，$P$成分の$s$行$(2l+1)$列行列($0 \leq l \leq sm$)全体を表すとすると，
