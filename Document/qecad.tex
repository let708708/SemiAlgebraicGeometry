...
$S \subset R^{n-1}$を空でない半代数的連結な半代数的集合部分集合とし，$f_1$, $f_2 \in \R[x_1, \dots, x_n]$が次を満たすとする.
\begin{itemize}
...
\begin{thebibliography}{99}
     ...
     \bibitem{} Scott McCallum, An Improved Projection Operation for Cylindrical Algebraic Decomposition(1998)
\end{thebibliography}
