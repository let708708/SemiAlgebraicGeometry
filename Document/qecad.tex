...
\section{導入}\label{section:1}
     ...
     \begin{figure}[H]
          ...
          \begin{tikzpicture}[scale=1.5]
               ...
               \fill ({sqrt(1/2)},-3) circle(0.05 and 0.05);     
               \fill (1,-3) circle(0.05 and 0.05);
               % \draw (-1.5, -3) node[above]{$S_1$};
               % \draw (-1,-3) node[below]{$S_2$};
               % \draw (-0.85355,-3) node[above]{$S_3$};
               % \draw (-{sqrt(1/2)},-3) node[below]{$S_4$};
               % \draw (0, -3) node[above]{$S_5$};
               % \draw ({sqrt(1/2)},-3) node[below]{$S_6$};
               % \draw (0.85355,-3) node[above]{$S_7$};
               % \draw (1,-3) node[below]{$S_8$};
               % \draw (1.5, -3) node[above]{$S_9$};
          \end{tikzpicture}
