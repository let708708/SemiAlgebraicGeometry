...
\section{導入}\label{section:1}
     ...
     すなわち，任意の論理式に対して，それと同値な量化記号のない論理式が存在する．
     さらに，論理式に対してそれと同値な量化記号のない論理式を求めるアルゴリズムが知られている．
     本論文では，Collins\cite{MR0403962}が考案した，柱状代数分解による量化記号消去のアルゴリズムを紹介することが目的である．
